      ...
      <div className="bg-[#Ffffff] mt-2 mb-2 p-2 h-[70px] flex justify-between shadow-md">
        <Link to="/" className="flex">
          <div className="ml-[50px] flex mt-2">
            <span className="max-laptopL:w-[150x] max-laptopL:h-[30px] text-2xl font-bold bg-gradient-to-r from-[#173f35] to-[#14594c] hover:from-[#2f6f62] hover:to-[#267e6b] bg-clip-text text-transparent duration-300 transition-all ease-in-out ">
              Market Nest
            </span>
          </div>
