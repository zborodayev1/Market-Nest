...
router.post('/register', registerValidation, handleValidErr, UserController.register);
...
router.patch('/profile/password', checkAuth, UserController.patchProfilePassword);
